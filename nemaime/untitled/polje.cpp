...
using namespace std;
    ...
    //konstruktor
    Podmornica::Podmornica(char d, int lgth, vector<int> r, vector<int> c, int hit, string nme)
    {
        pravac=d;
        duzina=lgth;
        vrsta_podm=r;
    ...
    void Podmornica::koordinatePodmornice()
    {
    ...
    string Podmornica::getPodmornica(int v, int k)
    {
        for(int i=0; i<duzina; i++)
        {
